...
#     def create_user(self, email, sid, phone_number, department, name, password=None):
#         """
...
#     profile_pic = models.ImageField(blank=True, upload_to="profile/", null = True)
    
#     department = models.CharField(max_length=100)
#     facebook_profile = models.URLField(null=True, blank=True)
#     id_card_pic = models.ImageField(null=True, blank=True)
